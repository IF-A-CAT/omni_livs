...
of the Hikvision cameras. GNSS timestamps are converted from UTC or GPS time
generated by the receiver to UNIX time. Because the host receives time over the
